...
Look [`here`](https://rpi-comp-2026.onrender.com/) for a QR code to the demo video, and [`our website`](https://tbcs-entry-rpi.onrender.com/) for the competition poster.
